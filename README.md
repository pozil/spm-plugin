...
spm-plugin/1.0.3 darwin-x64 node-v14.17.3
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/spm/install.ts](https://github.com/pozil/spm-plugin/blob/v1.0.3/src/commands/spm/install.ts)_
...
_See code: [src/commands/spm/publish.ts](https://github.com/pozil/spm-plugin/blob/v1.0.3/src/commands/spm/publish.ts)_
<!-- commandsstop -->
