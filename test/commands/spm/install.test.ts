...
describe('spm:install', () => {
    test.withOrg({ username: 'test@org.com' }, true)
        ...
        .it('runs spm:install --targetusername test@org.com', (ctx) => {
            expect(ctx.stdout).to.contain(
                'Hello world! This is org: Super Awesome Org and I will be around until 2018-03-20!'
            );
        });
});
